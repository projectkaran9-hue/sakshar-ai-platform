      ...
      <main className="flex-1 flex flex-col overflow-y-auto lg:overflow-hidden pr-0 lg:pr-2">
        ...
        {currentNav === 'dashboard' && (
          <div className="flex-1 flex flex-col space-y-6 overflow-y-auto pr-0 sm:pr-1 scrollbar-none animate-fade-in">
            ...
            `}</style>
            {/* 🌟 Mockup Animated Geometric Shapes Feature Hero Card ("My Learning Environment") */}
            <div className="animate-card-pop relative rounded-[2.5rem] bg-[#0b1021] text-white p-6 sm:p-8 overflow-hidden shadow-2xl border border-white/10">
