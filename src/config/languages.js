...
export const translations = {
  ...
  telugu: {
    ...
    googleSignIn: "గూగుల్‌తో కొనసాగండి", newHere: "ఇక్కడ కొత్తవారా?", alreadyHaveAccount: "ఇప్పటికే खाता ఉందా?", landingTitle: "AI ద్వారా అಕ್ಷరాస్యత సాధికారత",
  ...
  kannada: {
    ...
    googleSignIn: "ಗೂಗಲ್‌ನೊಂದಿಗೆ ಮುಂದುವರಿಯಿರಿ", newHere: "ಇಲ್ಲಿ ಹೊಸಬರೇ?", alreadyHaveAccount: "ಈಗಾಗಲೇ ಖಾತೆ ಹೊಂದಿದ್ದೀರಾ?", landingTitle: "AI ಮೂಲಕ ಸಾಕ್ಷರತೆಯ ಸಬಲೀकरण",
  ...
  odia: {
    ...
    googleSignIn: "ଗୁଗଲ୍ ସହିତ ଆଗକୁ ବଢନ୍ତୁ", newHere: "ଏଠାରେ ନୂଆ କି?", alreadyHaveAccount: "ପୂର୍ବରୁ ଆକาଉଣ୍ଟ୍ ଅଛି କି?", landingTitle: "AI ମାଧ୍ୟମରେ ସାକ୍ଷରତା ସଶକ୍ତିକରଣ",
    landingSub: "ଏକ ବ୍ୟକ୍ତିଗତ ଶିକ୍ଷଣ ସାଥୀ ଯାହା ବୟସ୍କ ଏବଂ ପ୍ରଥମ ପିଢ଼ିର ଶିକ୍ଷାର୍ଥୀମାନଙ୍କୁ ଆଞ୍ଚଳିକ ଭାଷାରେ ମୌଳିକ ପଢିବା, ଲେଖିବା ଏବଂ କହିବା ଦକ୍ଷତା ହାସଲ କରିବାରେ ସାହାଯ្យ କରିବା ପାଇଁ ପ୍ରସ୍ତուତ କରାଯାଇଛି ।",
    getStarted: "ଆରମ୍ଭ କରନ୍ତୁ", registerTitle: "ଆପଣଙ୍କ ଆକାଉଣ୍ଟ୍ ତିଆରି କରନ୍ତು", registerSub: "ଆମ ସମୁଦାୟରେ ଯୋਗ ଦିଅନ୍ତୁ ଏବଂ ଶିକ୍ଷାର ପରିସରକୁ ବୃଦ୍ଧି କରନ୍ତୁ ।",
    languageLabel: "🌐 ପସନ୍ଦର ମାତୃଭାଷା", registerLeftTitle: "ଆପଣଙ୍କର ସାକ୍ଷରତା ଯାত୍ରା ଏଠାରୁ ଆରମ୍ଭ ହୁଏ ।",
    registerLeftSub: "ଭଏସ୍ ପ୍ରାକ୍ଟିସ୍ ଆସେସମେଣ୍ଟ୍ ଏବଂ ଦୈନିକ ପଠନ ପାଠ୍ୟକ୍ରମକୁ ଅନଲକ୍ କରିବା ପାଇଁ ଏକ প্ৰୋଫାଇଲ୍ ତିଆରି କରନ୍ତୁ ।",
    loginLeftTitle: "ଆପଣ ଶିଖୁଥିବା ପ୍ରତ୍ୟେକ ଶବ୍દ ଏկ ନୂତନ ଦ୍ୱାର ଖୋଲିଥାଏ ।", loginLeftSub: "ବ୍ୟକ୍ତିଗତ ପଢିବା, ଲେଖିବା ଏବଂ କହିବା ଅଭ୍ୟาସ — ଆପଣଙ୍କ ନିଜ ଭାଷାରେ, ଆପଣଙ୍କ ନିଜ ଗତିରେ ।",
  ...
  urdu: {
    ...
    getStarted: "شروع کریں", registerTitle: "अपना अकाउंट बनाएं", registerSub: "ہماری کمیونٹی میں شامل ہوں اور اپنے सीखने के افق کو وسعت دیں۔",
  ...
  maithili: {
    ...
    landingSub: "एकटा व्यक्तिगत शिक्षण साथी जे वयस्क आ पहিল पीढ़िक सीखनिहार लोकनिकेँ क्षेत्रीय भाषामे बुनियादी पढ़ब, लिखब आ बाजबाक कौशल हासिल करबामे मद्दতি करबाक लेल बनाओल गेल अछि।",
    getStarted: "शुरू करू", registerTitle: "अपन खाता बनाउ", registerSub: "हमर समुदायमे शामिल होऊ आ अपन सीखबाक दायरा बढाउ।",
    languageLabel: "🌐 पसंदीदा मातृभाषा", registerLeftTitle: "अहाँক साक्षरताक यात्रा एतय सं शुरू होइत अछि।",
    registerLeftSub: "आवाज अभ्यास मूल्यांकन आ दैनिक पढ़बाक पाठकेँ अनलॉक करबाक लेल एकटा प्रोफाइल बनाउ।",
    loginLeftTitle: "अहाँक द्वारा सीखल गेल हर शब्द एकटा नव कपाट खोलैত अछि।", loginLeftSub: "व्यक्तिगत पढ़ब, लिखब आ बाजबाक अभ्यास — אहाँक अपन भाषामे, अपन गति सं।",
  ...
  santhali: {
    ...
    signInSub: "ᱟᱢᱟᱜ ᱪᱮਦᱚᱜ ᱦᱚᱨา ᱞᱟᱦᱟ ᱤᱫᱤ ᱞᱟᱹᱜᱤᱫ ᱥᱟᱭᱤᱱ ᱤᱱ ᱢᱮ ᱾", email: "✉️ ਈਮੇਲ ᱴᱷੇਕਾᱬָᱟ", password: "🔒 ᱯᱟᱥᱣᱟᱨᱰ", fullName: "👤 ᱯᱩᱨᱟᱹ ᱧᱩᱛᱩᱢ", or: "ᱪᱮ",
    googleSignIn: "ᱜᱩᱜᱚᱞ ᱥᱟᱶ ᱞᱟᱦᱟᱜ ᱢᱮ", newHere: "ᱱᱚᱸᱰེ ᱱᱟᱣา ᱜᱮᱭᱟᱢ?", alreadyHaveAccount: "ᱞᱟᱦᱟ ᱠᱷᱚն ᱠᱷﺎᱛา ᱢᱮᱱᱟᱜ-ᱟ?", landingTitle: "AI ᱛᱮ ᱚլ ᱯᱟᱲᱦᱟᱣ ᱞᱟᱦᱟନ୍ତି",
    landingSub: "ᱢᱤᱫ ᱟᱯնᱟᱨ ᱪᱮਦᱚᱜ ᱜᱟᱛᱮ ᱡᱟᱦาᱸᱭ ᱫᱚ ᱦᱟᱨᱟ ᱵᱩᱨᱩ ᱟᱨ ᱯᱩᱭᱞᱩ ᱯᱤᱲᱦᱤ ᱪᱮਦᱚᱜ ᱠᱚ ᱟᱠᱚᱣᱟᱜ ᱟᱭᳵ ᱟᱲᱟᱝ ᱛᱮ ᱚլ, ᱯᱟᱲᱦᱟᱣ ᱟᱨ ᱨᱚᱲ ᱪᱮਦᱚᱜ ᱨե ᱜᱚᱲᱚ ᱮᱢา ᱠᱚᱣᱟ ᱾",
    getStarted: "ᱮᱦۆᱵ ᱢᱮ", registerTitle: "ᱟᱢาᱜ ᱠᱷﺎᱛᱟ ᱵᱮᱱᱟᱣ ᱢᱮ", registerSub: "ᱟᱞᱮ ᱥᱟᱶ ᱡᱩᱲᱟᱹᱣ ᱢᱮ ᱟᱨ ᱟᱢᱟᱜ ᱜᱮᱭᱟᱱ ᱯᱟਸᱱᱟᱣ ᱢᱮ ᱾",
    languageLabel: "🌐 ᱠᱩᱥᱤᱭᱟᱜ ᱟᱭᳵ ᱟᱲᱟᱝ", registerLeftTitle: "Aᱢᱟᱜ ᱥᱮᱪᱮਦ ᱦᱚᱨᱟ ᱱᱚᱸᳰե ᱠᱷᱚն ᱮᱦᱚᱵᱚᱜ-า ᱾",
    registerLeftSub: "Aᱲᱟᱝ ᱵᱤᰰᱟᱹᱣ ᱟᱨ དིᱱᱟᱹމ ᱯᱟᱲᱦᱟᱣ ᱞᱮᱥᱚᱱ ᱠᱚ ᱡᱷᱤᱡ ᱞᱟᱹᱜᱤᱫ ᱯᱨᱚᱯᱷᱟᱭᱤᱞ ᱵᱮնᱟᱣ ᱢᱮ ᱾",
    loginLeftTitle: "ᱪᱮᱫᱚᱜ ᱨᱮᱱᱟᱜ ᱢᱤᱫ ᱢᱤᱫ ᱥᱟᱵาᱫ ᱱᱟᱣᱟ དུ་ᱣᱟᱹր ᱡᱷᱤᱡ-ᱟ ᱾", loginLeftSub: "ᱟପնᱟᱨ ᱯᱟᱲᱦᱟᱣ, ᱚլ ᱟᱨ ᱨᱚᱲ ᱨᱮᱱᱟᱜ ᱵᱤᰰᱟᱹᱣ — ᱟᱢᱟᱜ ᱛᱮ, ᱟᱢᱟᱜ ᱛᱟᱹᱞ ᱛᱮ ᱾",
    dashboardTitle: "ᱟᱢᱟᱜ ᱰᱮᱥᱵᱳᱨᱰ ᱨᱮ ᱥᱟᱹᱜᱩն ᱫtransition!", logout: "ᱳᱰᱳᱜ ᱢᱮ"
  },
  kashmiri: {
  ...
  nepali: {
    ...
    registerLeftSub: "आवाज अभ्यास मूल्याङ्കन र दैनिक पढ्ने पाठहरू अनलक गर्न प्रोफाइल सिर्जना गर्नुहोस्।",
  ...
  sindhi: {
    ...
    googleSignIn: "گوگل سان جاري رکو", newHere: "هتي نوان آهيو？", alreadyHaveAccount: "پهرين کان खातो آهي？", landingTitle: "AI جي ذريعي تعليم جي سجاڳي",
